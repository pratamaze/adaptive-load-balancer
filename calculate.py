...
def hitung_evaluasi(file_log):
    ...
    # CPU murni persentase normalized 0..100 dari log DECISION.
    # Tidak ada weighting kapasitas node dan tidak ada rekonstruksi ke satuan fisik.
    ...
    print("=" * 50)
    print(" LAPORAN EVALUASI LOAD BALANCER ")
    print("=" * 50)
    ...
    print(f"   Balanced CPU (BCU)        : {bcu:.4f}")
    print("=" * 50)
